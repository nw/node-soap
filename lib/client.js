...
Client.prototype.load = function load(wsdl){
  ...
  if(wsdl instanceof WSDL.WSDL){
    ...
    WSDL.load(wsdl, utils.extend(true, this.options), function(err, wsdl){
...
Client.prototype._defineMethod = function(method, location) {
  ...
  return function(args, options, callback) {
    ...
    self._invoke(method, args, location, options, function(error, result, raw) {
      callback(error, result, raw);
    });
  };
};

Client.prototype._invoke = function(method, args, location, options, callback) {
  var self = this,
    name = method.$name,
    input = method.input,
  ...
  options = utils.extend(true, {}, self.options.request, {headers: self.options.headers}, options);

  utils.request(location, xml, options, function(err, response, body) {
    var result;
    var obj;
